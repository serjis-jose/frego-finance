...
The code has already been updated in `frego-finance`. For `frego-backend`, apply similar changes:
...
curl -H "X-Tenant-ID: <tenant-uuid>" http://localhost:8080/frego/api/v1/jobs
