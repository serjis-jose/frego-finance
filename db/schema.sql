...
CREATE TABLE IF NOT EXISTS journal_entry_lines (
  ...
  party_id         uuid REFERENCES party_master(id),      -- customer/vendor
  job_id           uuid REFERENCES ops_job(id),
...
CREATE TABLE IF NOT EXISTS ar_invoice (
  ...
  customer_id              uuid NOT NULL REFERENCES party_master(id),
  job_id                   uuid REFERENCES ops_job(id),
...
CREATE TABLE IF NOT EXISTS ap_vendor_invoice (
  ...
  vendor_id                   uuid NOT NULL REFERENCES party_master(id),
  invoice_date                date NOT NULL,
  due_date                    date,
  payment_term_code           text REFERENCES payment_term_lu(code),
...
CREATE TABLE IF NOT EXISTS ap_vendor_invoice_line (
  ...
  ops_provision_id          uuid REFERENCES ops_provision(id),
  item_description          text NOT NULL,
  quantity                  numeric(14,3),
  unit_price                numeric(14,2),
