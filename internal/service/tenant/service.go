...
import (
	...
	"frego-finance/internal/repository/tenant"
...
func (s *Service) ProvisionTenant(ctx context.Context, tenantID uuid.UUID, schemaName string) error {
	return s.repo.ProvisionTenant(ctx, tenantID, schemaName)
}
